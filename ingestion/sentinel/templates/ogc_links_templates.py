...
["WMS","http://www.opengis.net/spec/owc/1.0/req/atom/wms", "GET", "GetMap", "image/jpeg", "http://...", "${host}/{{workspace}}/{{layer}}/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&FORMAT=image%2Fjpeg&STYLES&LAYERS={{workspace}}%3A{{layer}}&SRS=EPSG%3A4326&WIDTH=708&HEIGHT=768&BBOX=-121.77303314186096%2C37.10643768333435%2C-121.28711700462341%2C37.63355255104065"],
...
["WCS", "http://www.opengis.net/spec/owc/1.0/req/atom/wcs", "GET", "GetCoverage", "image/tiff", "${host}/{{workspace}}/{{layer}}/ows?service=WCS&version=2.0&request=GetCoverage&coverageid=S1A_IW_SLC&format=image%2Fgeotiff&BoundingBox=-121.77303314186096%2C37.10643768333435%2C-121.28711700462341%2C37.63355255104065%2Curn:ogc:def:crs:epsg::4326", "0+"],
